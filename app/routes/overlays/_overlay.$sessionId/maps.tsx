	...
	return (
		<div className="w-screen p-4 rounded-lg shadow-lg bg-[url(/images/puggMousepad2.png)] bg-no-repeat bg-cover h-screen !overflow-hidden">
			...
			<div className="flex flex-row px-8 w-full h-full">
				{maps.map((map, index) => (
					<motion.div
						...
						key={map.id}
						className={cn("relative h-[75%] w-full overflow-hidden", index == previousMapIndex && "w-[120%]", index != 0 && "border-l-4 border-gray-800")}
            style={{
            ...
            >
						...
						<div className={cn("absolute bottom-0 left-0 right-0 bg-gray-700 bg-opacity-70 p-2 text-white", index % 2 == 0 && "bg-gray-800")}>
