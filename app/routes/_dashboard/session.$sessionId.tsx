  ...
  return (
    <div className="container mx-auto p-4">
                ...
                <div key={team} className="space-y-4">
                    ...
                    <div className="flex items-center">
                      <div className="flex flex-col mr-2">
                        ...
                        <Button
                          ...
                          variant="destructive"
                          onClick={() =>
                            handleScoreChange(team as 1 | 2, false)
                          }
                      ...
                      <span className="text-3xl font-bold">
                        {
                          session[
                            `team${team}Score` as 'team1Score' | 'team2Score'
                          ]
                        }
                      </span>
                    </div>
                  ...
                  <div className="flex space-x-4">
                    <div className="flex-1">
                      <Label htmlFor={`team${team}Abbreviation`}>
                        Abbreviation
                      </Label>
                      <Input
                    ...
                    <div className="flex-1">
                      ...
                      <Input
                        ...
                        value={
                          session[
                            `team${team}Record` as 'team1Record' | 'team2Record'
                          ]
                        }
                        onChange={handleInputChange}
                        className="w-full h-10 p-1 bg-transparent border-2 border-gray-600 rounded"
                    ...
                    <div className="flex-1">
                      ...
                      <Input
                        ...
                        value={
                          session[
                            `team${team}Rank` as 'team1Rank' | 'team2Rank'
                          ]
                        }
                        onChange={handleInputChange}
                        className="w-full h-10 p-1 bg-transparent border-2 border-gray-600 rounded"
                  ...
                  <div className="flex space-x-4">
                    <div className="flex-1">
                      ...
                      <Input
                        ...
                        value={
                          session[
                            `team${team}Color` as 'team1Color' | 'team2Color'
                          ]
                        }
                        onChange={handleInputChange}
                        className="w-full h-10 p-1 bg-transparent border-2 border-gray-600 rounded"
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button variant="outline" className="w-full h-10">
                            {session[
                              `team${team}Logo` as 'team1Logo' | 'team2Logo'
                            ] ? (
                              <img
                                src={
                                  session[
                        ...
                        <PopoverContent className="w-40">
                          <div className="grid gap-4">
                            <Button
                              onClick={() =>
                                handleLogoChange(team as 1 | 2, 'url')
                              }
                            >
                            ...
                            <Button
                              onClick={() =>
                                handleLogoChange(team as 1 | 2, 'file')
                              }
                            >
      ...
      {session.game === 'Overwatch' && (
        <MatchMapsDashboard sessionId={sessionId} gameMaps={OverwatchMaps} />
      )}
