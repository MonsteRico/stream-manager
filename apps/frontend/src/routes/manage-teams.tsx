...
import type { Team } from "@stream-manager/shared";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function ManageTeamsPage() {
  ...
  const importTeams = async () => {
    ...
    try {
      ...
      if (!eventSlug) {
        window.alert(
          "Something was wrong with the link, make sure it matches the example!"
        );
        return;
      }
    ...
    <div className="container mx-auto p-4 space-y-8">
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            This will import all the teams from a start.gg event. You can find
            the event slug in the URL of the event page. This will only import
            the names and logos, so you will have to manually set anything else
            on the dashboard!
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="w-full max-w-2xl mx-auto mt-8">
        <CardHeader>
          ...
          <CardDescription>
            Unfortunately you cannot edit locally saved teams. When you use the
            team on the dashboard, you can still edit the values then.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction onClick={clearAllTeams}>
