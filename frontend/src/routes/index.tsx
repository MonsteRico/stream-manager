      ...
      <main>
        <section className="container mx-auto px-4 py-12 text-center">
          <h2 className="text-4xl font-extrabold mb-4">
            Manage Your Match Streams with Ease
          </h2>
          <p className="text-xl text-muted-foreground mb-8">
            Making it easier than ever to spin up a match stream with just a few
            clicks.
          </p>
          <Button
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  Manage team name, colors, logo, score and more with a simple
                  dashboard.
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  Quickly add all the overlays to OBS with a single click.
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  You can easily run your stream now with the dashboard, from
                  switching scenes to updating scores!
                </CardContent>
              </Card>
            </div>
          </div>
